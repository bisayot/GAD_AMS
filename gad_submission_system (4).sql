...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 13, 2026 at 12:10 PM
...
(1, '2026-0601', 1, 'SAMPLE Accomplishment Report of -- (SAMPLE Activity Design FOR TESTING)', '2026-08-29', '2026-08-29', '13:00:00', '16:00:00', 'CTE Function Hall', 132, 58, 74, 3, '1781351183_33b4d14fb41d14461064.pdf', 2, 'Pending', '2026-06-13 11:46:23', NULL);
...
(7, 2, 34.00, 21.00, 71.00, 0.00, 4.00, 21.00, 17.00, 60.00),
(10, 4, 1376.00, 7.00, 41.00, 77.00, 100.00, 97.00, 707.00, 98.00);
...
INSERT INTO `activity_design` (`act_design_id`, `activity_title`, `start_date`, `end_date`, `start_time`, `end_time`, `status`, `attachment`, `user_id`, `gpb_id`, `venue`, `venue_id`, `target_participants`, `proposed_budget`, `form_type`, `remarks`, `accomplishment_deadline`) VALUES
(2, 'SAMPLE Activity Design FOR TESTING v2', '2026-07-07', '2026-07-07', '14:30:00', '16:25:00', 'Pending', '1781345589_ec61190dc3a535ba2309.pdf', 2, NULL, 'Gymnasium', NULL, 4, 228, 'extension', 'Revise all', NULL),
(4, 'SAMPLE Staff Activity Design FOR TESTING v2', '1986-07-15', '2026-07-16', '13:00:00', '16:00:00', 'Pending', '1781350699_6918aaab3816c1b7c6f0.pdf', 47, NULL, 'Main Auditorium', NULL, 145, 2503, 'inset', 'acf qrxre2q3', NULL);
...
(1, 1, 'SAMPLE Activity Design FOR TESTING', '2026-08-29', '2026-08-29', '13:00:00', '16:00:00', 'Approved', '1781333222_691d718f22f448b4c11f.pdf', 2, NULL, 'CTE Function Hall', NULL, 90, 267, 'inset', '2026-06-13', '2026-07-16', 'Date REvise please', '2026-06-13 09:39:49'),
(2, 3, 'SAMPLE Staff Act Design FOR TESTING', '2026-06-26', '2026-06-26', '10:00:00', '12:00:00', 'Approved', '1781350115_2dbc320b5d818978c219.pdf', 47, NULL, 'Main Auditorium', NULL, 123, 1122, 'extension', '2026-06-13', '2026-06-30', '', '2026-06-13 11:33:44');
...
--
ALTER TABLE `activity_design`
  MODIFY `act_design_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `control_number`
  MODIFY `control_number_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
