...
.section-card { background: rgba(0, 0, 0, 0.2); border-radius: 16px; padding: 24px; border: 1px solid rgba(185, 121, 204, 0.15); min-width: 0; max-width: 100%; margin-bottom: 24px; }
