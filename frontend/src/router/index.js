...
const routes = [
  ...
  // College / TWG
  {
    ...
    children: [
      ...
      { path: 'messages', name: 'college-messages', component: () => import('../views/college/MessagesView.vue') },
  ...
  // Staff
  {
    ...
    children: [
      ...
      { path: 'contact-inquiries', name: 'staff-contact-inquiries', component: () => import('../views/admin/ContactInquiriesView.vue') },
